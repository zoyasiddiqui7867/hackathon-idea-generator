...
function Home() {
    return (
        <div className ="min-h-screen flex item-centre justify-center p-5">
            <div className="text-center">
                <h1 className="text-3xl md:text-5xl front-extrabold text-white mb-3 leading-tight">
                     Hack Smarter. Build Faster. Win Bigger<br className="hidden md:block" />with AI Ideas
        </h1><p className="text-lg md:text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
